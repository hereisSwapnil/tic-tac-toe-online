...
export const Grid = ({
  ...
  return (
    <div className="relative grid grid-cols-3 gap-4 w-[270px] m-auto">
      {gameState.map((row, i) =>
        row.map((value, j) => (
          <Box
            key={i * 3 + j}
      ...
      {gameFinished ? (
        <div className="absolute w-[270px] h-[270px] flex justify-center items-center m-auto bg-[#131c2b43] rounded-lg">
          <svg
